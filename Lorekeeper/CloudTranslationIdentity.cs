...
{
    // Wersja protokołu/rekordu akceptowana przez Worker.
    // Korekty tłumaczeń nie zmieniają lookup key: nowsza wersja klienta
    // może zaktualizować kanoniczny tekst w Cloud dla tego samego wpisu.
